...
async function main() {
  ...
  await page.locator('[data-monitoring-company="ent-005"]').click();
  await page.locator('#monitoring-3d[data-selected-company="ent-005"]').waitFor();
  await page.getByRole("heading", { name: /涂装车间/ }).last().waitFor();
